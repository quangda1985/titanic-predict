...
# Part 2: Hien thi ket qua tren Streamlit
...
if choice =='Overview':
	...
	if prediction[0] == 1:
		...
		st.subheader('Passenger {} would not have survived with a probability of {}%'.format(name,round(predict_probability[0][0]*100 , 2)))
